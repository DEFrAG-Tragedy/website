...
<template>
  <div class="ribbon" :style="{ top: ribbonTop }" @click="appStore.toggleXmlContent">
    <span>{{title}}</span>
  </div>

  <div
      v-if="appStore.isXmlContentOpened"
      id="sidebarBackdrop"
      ...
      style="z-index: 59;"
      @click="appStore.closeXmlContent"
  ></div>
  ...
  <div
    ...
    transition-transform duration-300 ease-in-out"
      :class="{
    'translate-x-0': appStore.isXmlContentOpened,
    'translate-x-full': !appStore.isXmlContentOpened,
  }"
      role="dialog"
      tabindex="-1"
      aria-label="Sidebar"
  >
    ...
    <div class="px-9 cursor-pointer" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-offcanvas-menu" aria-label="Toggle navigation" @click="appStore.closeXmlContent">
