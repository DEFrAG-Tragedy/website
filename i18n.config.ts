export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            sabinaCastellanetaDescription: `Associate Professor in Ancient Greek Literature at the University of Bari, she is the creator of the DEFrAG-Tragedy project. In addition to the work on <i>Digital Scholarly Editions</i>, her research focuses on Attic drama, with particular attention to Euripidean tragedy, as well as on Homeric epic, Stesichorean lyric, and Hellenistic poetry. Her publications include a volume on Euripides’ stay in Macedonia (Alessandria 2021) and editions of <i>Temenos</i> (Trieste 2023) and Euripides’ <i>Temenidae</i> (Rome 2025).`,
            andreaGiannottiDescription: `Teaching Fellow in Classics and Ancient History at Durham University, his research focuses on Greek tragedy—particularly Euripidean—through the lens of honorific epigraphy and modern socio-cognitive theories. Among his publications on Greek tragedy, history, and epigraphy are editions of Euripides’ <i>Suppliant Women</i> (Milano 2023), <i>Children of Heracles</i> (Milano 2025), and the Pseudo-Euripides’ <i>Letters</i> (Liverpool 2026; with G.A. Gazis).`,
            nadiaRossoDescription: `Post-doctoral Research Fellow and Contract Lecturer in Greek Language and Literature at the University of Eastern Piedmont. Her primary research interests include Greek tragedy, Greek metre, and Greek-Latin bilingualism in Late Antiquity, with a particular focus on Digital Humanities and their applications in philological and linguistic studies. She has published the critical edition with commentary of <i>Phrixus I</i> and <i>II</i> by Euripides (Trieste 2024).`,
            lorenzaSavignagoDescription: `Associate Professor in Greek Literature at the University of Trieste. Her research focuses primarily on Greek metrics and the textual tradition of dramatic texts. She has published a monograph on Eisthesis. <i>Il sistema dei margini nei papiri dei poeti tragici</i> (Alessandria 2008) and is currently preparing the critical edition of the Triclinian metrical <i>scholia</i> on Sophocles’ <i>Trachiniae, Philoctetes, Oedipus at Colonus</i>.`,
            ...
            danielaColomoDescription: "Associate Professor in Papyrology at the Università degli Studi di Milano, and Curator of the University papyri and <i>ostraka</i> collection Achille Vogliano. Her research interests include literary, paraliterary and documentary papyri, in particular rhetorical, Biblical, magical texts and papyri related to ancient scholarship. Among her publications is the edition of <i>P.Oxy. 5093, Rhetorical Epideixeis</i> (<i>The Oxyrhynchus Papyri</i>, vol. LXXVI, London 2011, pp. 84–171).",
        ...
        it: {
            ...
            claudioStefaniDescription: "Professore associato di Lingua e Letteratura Greca presso Università\n" +
            ...
            danielaColomoDescription: "Professore Associato di Papirologia all’Università degli Studi di Milano e responsabile della collezione di papiri e <i>ostraka</i> Achille Vogliano. I suoi interessi di ricerca includono papiri letterari, paraletterari e documentari, in particolare testi retorici, biblici, magici e papiri relativi all’erudizione antica. Tra le sue pubblicazioni si menziona l’edizione del <i>P.Oxy. 5093, Rhetorical Epideixeis</i> (<i>The Oxyrhynchus Papyri</i>, vol. LXXVI, London 2011, pp. 84-171)."
