export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            nadiaRossoDescription: `Post-doctoral Research Fellow and Contract Lecturer in Greek Language and Literature at the University of Eastern Piedmont. Her primary research interests include Greek tragedy, Greek metre, and Greek-Latin bilingualism in Late Antiquity, with a particular focus on <i>Digital Humanities</i> and their applications in philological and linguistic studies. She has published the critical edition with commentary of <i>Phrixus I</i> and <i>II</i> by Euripides (Trieste 2024).`,
            lorenzaSavignagoDescription: `Associate Professor of Greek Literature at the University of Trieste. Her research focuses primarily on Greek metrics and the textual tradition of dramatic texts. She has published a monograph on Eisthesis. <i>Il sistema dei margini nei papiri dei poeti tragici</i> (Alessandria 2008) and is currently preparing the critical edition of the Triclinian metrical scholia on Sophocles’ <i>Trachiniae, Philoctetes, Oedipus at Colonus</i>.`,
            ...
            danielaColomoDescription: "Associate Professor of Papyrology at the Università degli Studi di Milano, and Curator of the University papyri and ostraca collection Achille Vogliano. Her research interests include literary, paraliterary and documentary papyri, in particular rhetorical, Biblical, magical texts and papyri related to ancient scholarship. Among her publications is the edition of P.Oxy. 5093, Rhetorical Epideixeis (The Oxyrhynchus Papyri, vol. LXXVI, London 2011, pp. 84–171).",
        ...
        it: {
            ...
            danielaColomoDescription: "Professore Associato di Papirologia all’Università degli Studi di Milano e responsabile della collezione di papiri e ostraca Achille Vogliano. I suoi interessi di ricerca includono papiri letterari, paraletterari e documentari, in particolare testi retorici, biblici, magici e papiri relativi all’erudizione antica. Tra le sue pubblicazioni si menziona l’edizione del P.Oxy. 5093, Rhetorical Epideixeis (The Oxyrhynchus Papyri, vol. LXXVI, London 2011, pp. 84-171)."
